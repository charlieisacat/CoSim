...
#for src in convmm_*_matmul.c; do
for src in convmm_256x256x256_matmul.c; do
#for src in convmm_512x512x512_matmul.c; do
#for src in convmm_1024x1024x1024_matmul.c; do
#for src in convmm_2048x2048x2048_matmul.c; do
    ...
    echo "/haoxiaoyu/uarch_exp/cosim/sim/build/my_program \
        ../$bc" \
        example.txt" \
