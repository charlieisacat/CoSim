...
int main (int argc, char * argv[]) {
    ...
    //     start = read_cycles();
        ...
        // tiled_matmul_nn_auto(1024, 64, 64,
...
// in_rows * in_cols , in_channel
elem_t conv_2_out[3136][64] row_align(1);
// kernel_size * kernel_size * in_channels, out_channels
elem_t conv_3_w[576][64] row_align(1);
// out_rows * out_cols, out_channel 
elem_t conv_3_out[3136][64] row_align(1);
        ...
        tiled_conv_auto(
            ...
            (elem_t*)conv_2_out, (elem_t*)conv_3_w, NULL, (elem_t*)conv_3_out,
    ...
    //     im2col_cycles += end - start;
        ...
        // tiled_matmul_nn_auto(64, 64, 2048,
