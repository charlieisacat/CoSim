#include "SA/CompilerMultiplierMesh.h"
#include "SA/Tile.h"
...
void CompilerMultiplierMesh::configureSignals(Tile *current_tile, Region *region, unsigned int ms_rows, unsigned int ms_cols)
{
...
void CompilerMultiplierMesh::generate_ms_signals(unsigned int ms_rows, unsigned int ms_cols)
{
    ...
    std::cout<<"rows_used: "<<rows_used<<" cols_used: "<<cols_used<<std::endl;
