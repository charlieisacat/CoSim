...
void SDMemoryStats::reset() {
    ...
    this->n_SRAM_read_ports_weights_use.clear();
    this->n_SRAM_read_ports_inputs_use.clear();
    this->n_SRAM_read_ports_psums_use.clear();
    this->n_SRAM_write_ports_use.clear();
}
