...
private:
    ...
    unsigned int Padded_T_N;
    unsigned int Padded_T_K;
    unsigned int Padded_T_M;
   ...
   void reset();
    ...
    std::deque<Command*> pending_cmds;
...
public:
    ...
    void preload(unsigned int T_M, unsigned int T_N, unsigned int offset, Command *cmd);
    ...
    bool is_compute_finished() { return this->execution_finished; }
    bool is_idle();
    void reset_compute_finished();
    Command* get_command();
